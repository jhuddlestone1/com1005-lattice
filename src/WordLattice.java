...
public class WordLattice{
  ...
  //accessors
  public ArrayList<WordH> getAllWordHs() {return wordHSet;};
  ...
  */
  ...
  public ArrayList<WordH> wordsAtT(int t){
   ArrayList<WordH> wordsFound = new ArrayList<WordH>();
    for(WordH wh: wordHSet){if (wh.getStart()==t) wordsFound.add(wh);};
    return wordsFound;
  }
  ...
  private void findEndTime (){
  	endTime=0;
  	for(WordH wh: wordHSet){if (wh.getEnd()> endTime) endTime=wh.getEnd();};
  }
